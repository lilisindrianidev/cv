          ...
          <div className="title_aboutMe">Get to know more About Me...
            <div className="cover_write_aboutMe">
              <div className="write_aboutMe">
                ...
                <p>
                  I am critical thinker, work creatively, able to work on team, and able to create new innovations using code that hopefully will bring the best progress in the future.
                </p>
              </div>
            </div>
          </div>
